...
import '../components/PagsAprendamos/saludFisica/SaludFisica.css'; // Importa el archivo CSS para los estilos

const ConsejosVidaSana = () => {
    return (

        <div style={{ backgroundColor: '#BFE1FA' }}>
            <div style={{ marginRight: '50px', marginLeft: '50px' }}>
                <div className='title-saludF'>
                    <h1 > Consejos para una vida sana</h1>
                </div>
                <div className="row">
                    <div className="card card-salud">
                        ...
                        <div className="face back" >
                            <h3 className="card-title" style={{ marginTop: '50px' }} >GUIAS ALIMENTARIAS PARA LA POBLACION CHILENA</h3>
                    ...
                    <div className="card card-salud narrower"> {/* Agrega la clase "narrower" al segundo card */}
                        ...
                        <div className="face back">
                            <h6 className="card-title">
                                ...
                                <p style={{ marginTop: '15px' }}>Recuerda comer fruta e hidratarte después de hacer actividad física.</p>
                            </h6>
                        </div>
                    </div>
                </div>
